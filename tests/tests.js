...
describe("Get Primes ", function() {
  describe("Case for some false values", function() {
    ...
    it("should return 'wrong input' for -1", function() {
      expect(app.getPrimes(-1)).toEqual('wrong input');
    })

  });


 describe("Case for numbers less than 2", function() {

    it("should return '[]' for  0", function() {
      expect(app.getPrimes()).toBe();
    });
  ...
  describe("Case for numbers less than 2", function() {
   ...
   describe("Case for greater than 2", function() {
